...
Label(root,text="Phương trình bật 1"
,fg="red",font=("tohama",16),justify=CENTER).grid(row=0,columnspan=2)
...
Button(frameButton,text="Tiếp",command=giaiAction).pack(side=LEFT)
